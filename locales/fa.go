	...
	translations := []struct {
	...
	}{
		{
			...
			customRegisFunc: func(ut ut.Translator) error {
				return ut.Add("required_if", "فیلد {0} زمانی که {1} برابر {2} است، اجباری می‌باشد.", true)
			},
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				t, _ := ut.T("required_if", fieldName, otherField, otherValue)
				return t
			},
		},
		{
			tag:         "oneof_required",
			translation: "حداقل یکی از فیلدهای موبایل، ایمیل یا نام‌کاربری الزامی است",
			override:    false,
		},
		{
			tag:         "exists",
			translation: "{0} انتخاب شده، معتبر نیست",
			override:    false,
		},
		{
			tag:         "mobile",
			translation: "شماره موبایل معتبر نمی‌باشد",
			override:    true,
		},
		{
			tag:         "string",
			translation: "{0} باید رشته باشد",
			override:    false,
		},
		{
			tag:         "uq",
			translation: "{0} قبلا انتخاب شده است",
			override:    false,
		},
		{
			tag:         "required",
		...
		},
		{
			...
			translation: "رمز عبور فعلی وارد شده صحیح نمی باشد",
			override:    false,
		},
		{
			tag: "len",
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("len-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("len-items", ToSnakeCase(fe.Field()), c)

				default:
					t, err = ut.T("len-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("min-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("min-items", ToSnakeCase(fe.Field()), c)

				default:
					t, err = ut.T("min-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("max-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("max-items", ToSnakeCase(fe.Field()), c)

				default:
					t, err = ut.T("max-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				t, err := ut.T(fe.Tag(), ToSnakeCase(fe.Field()), fe.Param())
				if err != nil {
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("lt-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lt-items", ToSnakeCase(fe.Field()), c)
				...
				default:
					...
					t, err = ut.T("lt-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("lte-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("lte-items", ToSnakeCase(fe.Field()), c)
				...
				default:
					...
					t, err = ut.T("lte-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("gt-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gt-items", ToSnakeCase(fe.Field()), c)
				...
				default:
					...
					t, err = ut.T("gt-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				...
				case reflect.String:
					...
					t, err = ut.T("gte-string", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Slice, reflect.Map, reflect.Array:
					...
					t, err = ut.T("gte-items", ToSnakeCase(fe.Field()), c)
				...
				case reflect.Struct:
					...
					t, err = ut.T("gte-datetime", ToSnakeCase(fe.Field()))
				...
				default:
					...
					t, err = ut.T("gte-number", ToSnakeCase(fe.Field()), ut.FmtNumber(f64, digits))
				}
		...
		{
			tag:         "email",
			translation: "{0} ایمیل معتبر نمی‌باشد",
			override:    false,
		},
		{
			tag:         "url",
		...
		},
		{
			...
			override:    false,
			customTransFunc: func(ut ut.Translator, fe validator.FieldError) string {
				s, err := ut.T(fe.Tag(), ToSnakeCase(fe.Field()), fe.Param())
				if err != nil {
					log.Printf("warning: error translating FieldError: %#v", fe)
					return fe.(error).Error()
				}
...
func translateFunc(ut ut.Translator, fe validator.FieldError) string {
	t, err := ut.T(fe.Tag(), ToSnakeCase(fe.Field()))
	if err != nil {
		return fe.(error).Error()
	}
